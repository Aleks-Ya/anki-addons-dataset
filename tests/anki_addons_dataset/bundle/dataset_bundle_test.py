...
def test_parse_snapshot_date(working_dir: WorkingDir, script_version: ScriptVersion):
    ...
    raw_metadata_collector_1.set_script_version(script_version)
    ...
    raw_metadata_collector_2.set_script_version(script_version)
