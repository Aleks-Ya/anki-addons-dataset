...
def test_export_addon_infos(snapshot_dir: SnapshotDir, addon_infos: AddonInfos,
...
def test_export_aggregation(snapshot_dir: SnapshotDir, dataset_snapshot_metadata: DatasetSnapshotMetadata,
