...
from anki_addons_dataset.common.data_types import AddonInfo, AddonHeader, AddonPage, AddonId, \
    AddonInfos, AnkiVersion, HtmlStr, URL, Rating, UpdateDate, AddonTitle
...
class Enricher(ABC, Thread):
    ...
    def __init__(self, name: str):
        ...
        self.__sentinel: AddonInfo = AddonInfo(AddonHeader(AddonId(0), AddonTitle(""), URL(""), Rating(0), UpdateDate(""), AnkiVersion("")),
